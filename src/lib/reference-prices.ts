...
export const REFERENCE_PRICES: ReferencePrice[] = [
  ...
  // ============= Specialty Items (2026 Reference) =============
  { keywords: ["elevator", "lift", "passenger elevator", "passenger lift"], keywordsAr: ["مصعد", "اسانسير", "مصعد ركاب"], unit: "no", minPrice: 80000, maxPrice: 350000, avgPrice: 180000, category: "specialty" },
  { keywords: ["freight elevator", "cargo lift", "service elevator"], keywordsAr: ["مصعد بضائع", "مصعد خدمة"], unit: "no", minPrice: 120000, maxPrice: 500000, avgPrice: 250000, category: "specialty" },
  { keywords: ["escalator", "moving stairway"], keywordsAr: ["سلم كهربائي", "سلم متحرك"], unit: "no", minPrice: 200000, maxPrice: 600000, avgPrice: 350000, category: "specialty" },
  { keywords: ["fire door", "fire rated door", "fire resistant door"], keywordsAr: ["باب مقاوم للحريق", "باب حريق"], unit: "no", minPrice: 1200, maxPrice: 5000, avgPrice: 2800, category: "fire_fighting" },
  { keywords: ["glass curtain wall", "curtain wall", "structural glazing"], keywordsAr: ["حائط ستائري زجاجي", "واجهة زجاجية"], unit: "m2", minPrice: 400, maxPrice: 1500, avgPrice: 800, category: "finishing" },
  { keywords: ["marble", "marble flooring", "marble cladding"], keywordsAr: ["رخام", "تكسية رخام", "أرضيات رخام"], unit: "m2", minPrice: 150, maxPrice: 800, avgPrice: 400, category: "finishing" },
  { keywords: ["granite", "granite flooring", "granite cladding"], keywordsAr: ["جرانيت", "تكسية جرانيت"], unit: "m2", minPrice: 120, maxPrice: 600, avgPrice: 350, category: "finishing" },
  { keywords: ["raised floor", "raised access floor", "access floor"], keywordsAr: ["أرضية مرتفعة", "أرضيات تقنية"], unit: "m2", minPrice: 100, maxPrice: 400, avgPrice: 220, category: "finishing" },
  { keywords: ["solar panel", "photovoltaic", "pv panel", "solar module"], keywordsAr: ["لوح شمسي", "طاقة شمسية", "خلايا شمسية"], unit: "no", minPrice: 500, maxPrice: 2500, avgPrice: 1200, category: "electrical" },
  { keywords: ["ev charging", "electric vehicle charger", "ev station"], keywordsAr: ["شاحن سيارات كهربائية", "محطة شحن"], unit: "no", minPrice: 5000, maxPrice: 50000, avgPrice: 20000, category: "electrical" },
  { keywords: ["steel railing", "handrail", "balustrade", "stainless railing"], keywordsAr: ["درابزين حديد", "سور حديد", "درابزين ستانلس"], unit: "m", minPrice: 150, maxPrice: 600, avgPrice: 350, category: "structural" },
  { keywords: ["stainless steel", "stainless steel cladding"], keywordsAr: ["ستانلس ستيل", "تكسية ستانلس"], unit: "m2", minPrice: 200, maxPrice: 800, avgPrice: 450, category: "finishing" },
  { keywords: ["aluminum cladding", "acm", "aluminium composite", "alucobond"], keywordsAr: ["تكسية ألمنيوم", "ألوكوبوند", "كلادينج"], unit: "m2", minPrice: 150, maxPrice: 500, avgPrice: 300, category: "finishing" },
  { keywords: ["grc panel", "grc cladding", "glass reinforced concrete"], keywordsAr: ["ألواح جي آر سي", "خرسانة مسلحة بالألياف"], unit: "m2", minPrice: 200, maxPrice: 700, avgPrice: 400, category: "finishing" },
  { keywords: ["precast panel", "precast wall panel", "precast facade"], keywordsAr: ["ألواح سابقة الصب", "واجهة مسبقة الصب"], unit: "m2", minPrice: 250, maxPrice: 800, avgPrice: 450, category: "concrete" },
  { keywords: ["swimming pool", "pool construction"], keywordsAr: ["حمام سباحة", "مسبح"], unit: "m2", minPrice: 2000, maxPrice: 6000, avgPrice: 3500, category: "specialty" },
  { keywords: ["fountain", "water fountain", "water feature"], keywordsAr: ["نافورة", "نافورة مياه"], unit: "no", minPrice: 10000, maxPrice: 200000, avgPrice: 80000, category: "specialty" },
  { keywords: ["parking system", "automated parking", "car lift"], keywordsAr: ["نظام مواقف", "مواقف آلية", "مصعد سيارات"], unit: "no", minPrice: 50000, maxPrice: 500000, avgPrice: 200000, category: "specialty" },
  { keywords: ["kitchen hood", "commercial kitchen hood", "exhaust hood"], keywordsAr: ["شفاط مطبخ", "هود مطبخ"], unit: "no", minPrice: 2000, maxPrice: 15000, avgPrice: 6000, category: "mep" },
  { keywords: ["garage door", "rolling shutter", "roller door"], keywordsAr: ["باب جراج", "شتر", "باب رولاب"], unit: "m2", minPrice: 200, maxPrice: 800, avgPrice: 450, category: "finishing" },
  { keywords: ["acoustic panel", "sound insulation", "acoustic treatment"], keywordsAr: ["لوح صوتي", "عزل صوتي", "معالجة صوتية"], unit: "m2", minPrice: 80, maxPrice: 400, avgPrice: 200, category: "finishing" },
  { keywords: ["clean room", "cleanroom", "controlled environment"], keywordsAr: ["غرفة نظيفة", "بيئة محكومة"], unit: "m2", minPrice: 2000, maxPrice: 8000, avgPrice: 4500, category: "specialty" },
  { keywords: ["cable bridge", "cable ladder"], keywordsAr: ["جسر كابلات", "سلم كابلات"], unit: "m", minPrice: 50, maxPrice: 250, avgPrice: 130, category: "electrical" },
  { keywords: ["fire damper", "smoke damper"], keywordsAr: ["مخمد حريق", "مخمد دخان"], unit: "no", minPrice: 200, maxPrice: 1200, avgPrice: 600, category: "fire_fighting" },
  { keywords: ["expansion tank", "pressure vessel"], keywordsAr: ["خزان تمدد", "وعاء ضغط"], unit: "no", minPrice: 500, maxPrice: 5000, avgPrice: 2000, category: "plumbing" },
  { keywords: ["septic tank", "sewage treatment"], keywordsAr: ["خزان صرف", "محطة معالجة"], unit: "no", minPrice: 5000, maxPrice: 80000, avgPrice: 30000, category: "plumbing" },
  { keywords: ["rainwater harvesting", "rainwater tank", "storm water tank"], keywordsAr: ["تجميع مياه أمطار", "خزان أمطار"], unit: "no", minPrice: 3000, maxPrice: 30000, avgPrice: 12000, category: "plumbing" },
  { keywords: ["dumbwaiter", "service lift", "food lift"], keywordsAr: ["مصعد خدمة", "مصعد طعام"], unit: "no", minPrice: 15000, maxPrice: 80000, avgPrice: 40000, category: "specialty" },
  { keywords: ["pergola", "canopy", "shade structure"], keywordsAr: ["برجولا", "مظلة", "هيكل تظليل"], unit: "m2", minPrice: 100, maxPrice: 500, avgPrice: 250, category: "landscaping" },
  { keywords: ["rubber flooring", "vinyl flooring", "lvt"], keywordsAr: ["أرضيات مطاط", "أرضيات فينيل"], unit: "m2", minPrice: 50, maxPrice: 200, avgPrice: 110, category: "finishing" },
  { keywords: ["metal ceiling", "aluminum ceiling", "baffle ceiling"], keywordsAr: ["سقف معدني", "سقف ألمنيوم"], unit: "m2", minPrice: 80, maxPrice: 350, avgPrice: 180, category: "finishing" },
  { keywords: ["concrete polishing", "polished concrete", "concrete grinding"], keywordsAr: ["تلميع خرسانة", "خرسانة مصقولة"], unit: "m2", minPrice: 30, maxPrice: 120, avgPrice: 65, category: "finishing" },
  { keywords: ["bollard", "security bollard", "traffic bollard"], keywordsAr: ["بولارد", "عمود حماية", "حاجز مرور"], unit: "no", minPrice: 500, maxPrice: 5000, avgPrice: 2000, category: "roads" },
  { keywords: ["speed bump", "speed hump", "road hump"], keywordsAr: ["مطب", "مطب صناعي"], unit: "no", minPrice: 300, maxPrice: 1500, avgPrice: 700, category: "roads" },
  { keywords: ["water meter", "flow meter"], keywordsAr: ["عداد مياه", "عداد تدفق"], unit: "no", minPrice: 100, maxPrice: 2000, avgPrice: 500, category: "plumbing" },
  { keywords: ["gas pipe", "gas supply", "natural gas pipe"], keywordsAr: ["مواسير غاز", "أنابيب غاز طبيعي"], unit: "m", minPrice: 30, maxPrice: 150, avgPrice: 70, category: "plumbing" },
  { keywords: ["sanitary ware", "bathroom set", "toilet set"], keywordsAr: ["أدوات صحية", "طقم حمام"], unit: "set", minPrice: 1000, maxPrice: 8000, avgPrice: 3500, category: "plumbing" },
  { keywords: ["central vacuum", "vacuum system"], keywordsAr: ["مكنسة مركزية", "نظام شفط"], unit: "no", minPrice: 5000, maxPrice: 30000, avgPrice: 15000, category: "mep" },
  { keywords: ["ice rink", "skating rink"], keywordsAr: ["حلبة تزلج", "ملعب جليد"], unit: "m2", minPrice: 3000, maxPrice: 10000, avgPrice: 6000, category: "specialty" },
];
