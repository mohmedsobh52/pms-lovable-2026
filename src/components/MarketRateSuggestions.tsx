...
const CITY_FACTORS: Record<string, { factor: number; label: string }> = {
  ...
  "NEOM": { factor: 1.35, label: "+35%" },
  "Qiddiya": { factor: 1.25, label: "+25%" },
  "Red Sea": { factor: 1.30, label: "+30%" },
  "Jubail": { factor: 1.03, label: "+3%" },
  "Yanbu": { factor: 1.08, label: "+8%" },
  "Hail": { factor: 1.10, label: "+10%" },
  "Jazan": { factor: 1.12, label: "+12%" },
  "Najran": { factor: 1.14, label: "+14%" },
  "Al Ahsa": { factor: 0.95, label: "-5%" },
  "Taif": { factor: 1.02, label: "+2%" },
  "Buraidah": { factor: 1.06, label: "+6%" },
  "Khamis Mushait": { factor: 1.10, label: "+10%" },
  "Al Kharj": { factor: 0.98, label: "-2%" },
  "Al Baha": { factor: 1.14, label: "+14%" },
  "Arar": { factor: 1.16, label: "+16%" },
  "Sakaka": { factor: 1.14, label: "+14%" },
  "Dawadmi": { factor: 1.06, label: "+6%" },
  "Zulfi": { factor: 1.08, label: "+8%" },
...
const REGION_CITIES: Record<string, Array<{ value: string; label: string }>> = {
  saudi: [
    ...
    { value: "NEOM", label: "نيوم / NEOM" },
    { value: "Qiddiya", label: "القدية / Qiddiya" },
    { value: "Red Sea", label: "البحر الأحمر / Red Sea" },
    ...
    { value: "Al Ahsa", label: "الأحساء / Al Ahsa" },
    { value: "Taif", label: "الطائف / Taif" },
    { value: "Buraidah", label: "بريدة / Buraidah" },
    { value: "Khamis Mushait", label: "خميس مشيط / Khamis Mushait" },
    { value: "Al Kharj", label: "الخرج / Al Kharj" },
    { value: "Al Baha", label: "الباحة / Al Baha" },
    { value: "Arar", label: "عرعر / Arar" },
    { value: "Sakaka", label: "سكاكا / Sakaka" },
    { value: "Dawadmi", label: "الدوادمي / Dawadmi" },
    { value: "Zulfi", label: "الزلفي / Zulfi" },
  ],
  uae: [
