...
import { Calendar, Clock, Play, ChevronLeft, ChevronRight, Loader2, Brain, Zap } from "lucide-react";
        ...
        <div className="p-4">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 flex relative">
                      ...
                      {isVisible && (
                        <div
                          className="absolute top-1/2 -translate-y-1/2 h-6 rounded-full transition-all duration-300 hover:h-7 cursor-pointer group"
                          style={{
                          ...
                          title={`${task.title} - ${task.duration} يوم`}
                        >
          ...
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-xl bg-gradient-to-br from-warning/10 to-warning/5 border border-warning/20 text-center">
              ...
              <p className="text-2xl font-bold text-warning">{timelineData.length}</p>
