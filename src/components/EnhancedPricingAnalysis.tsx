...
const LOCATIONS = [
  { value: "Riyadh", label: "الرياض / Riyadh", factor: "1.00x" },
  { value: "Jeddah", label: "جدة / Jeddah", factor: "1.05x" },
  { value: "Dammam", label: "الدمام / Dammam", factor: "0.97x" },
  { value: "Makkah", label: "مكة المكرمة / Makkah", factor: "1.08x" },
  { value: "Madinah", label: "المدينة المنورة / Madinah", factor: "1.04x" },
  { value: "Khobar", label: "الخبر / Khobar", factor: "0.98x" },
  { value: "Tabuk", label: "تبوك / Tabuk", factor: "1.12x" },
  { value: "Abha", label: "أبها / Abha", factor: "1.10x" },
  ...
  { value: "Jubail", label: "الجبيل / Jubail", factor: "1.03x" },
  { value: "Yanbu", label: "ينبع / Yanbu", factor: "1.08x" },
  { value: "Hail", label: "حائل / Hail", factor: "1.10x" },
  { value: "Jazan", label: "جازان / Jazan", factor: "1.12x" },
  { value: "Najran", label: "نجران / Najran", factor: "1.14x" },
  { value: "Al Ahsa", label: "الأحساء / Al Ahsa", factor: "0.95x" },
  { value: "Taif", label: "الطائف / Taif", factor: "1.02x" },
  { value: "Buraidah", label: "بريدة / Buraidah", factor: "1.06x" },
  { value: "Khamis Mushait", label: "خميس مشيط / Khamis Mushait", factor: "1.10x" },
  { value: "Al Kharj", label: "الخرج / Al Kharj", factor: "0.98x" },
  { value: "Al Baha", label: "الباحة / Al Baha", factor: "1.14x" },
  { value: "Arar", label: "عرعر / Arar", factor: "1.16x" },
  { value: "Sakaka", label: "سكاكا / Sakaka", factor: "1.14x" },
  { value: "Dawadmi", label: "الدوادمي / Dawadmi", factor: "1.06x" },
  { value: "Zulfi", label: "الزلفي / Zulfi", factor: "1.08x" },
];
